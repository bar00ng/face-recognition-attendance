package com.example.absen_pegawai.helpers.vision.recogniser;
...
import com.example.absen_pegawai.ScanUserFaceActivity;
import com.example.absen_pegawai.helpers.vision.FaceGraphic;
import com.example.absen_pegawai.helpers.vision.GraphicOverlay;
...
//                            }
    ...
    private Pair<String, Float> findNearestFace(float[] vector) {
        ...
        for (ScanUserFaceProcessor.Employee user : recognisedFaceList) {
    ...
    public void registerFace(String userId, float[] tempVector) {
        ...
        recognisedFaceList.add(new ScanUserFaceProcessor.Employee(userId, tempVector));
